...
class _Pickler:
    ...
    def __init__(self, file, protocol=None, *, fix_imports=True):
        ...
        elif not (0 <= protocol and protocol <= HIGHEST_PROTOCOL):
        ...
        if self.bin:
            if obj >= 0:
                ...
                if obj <= 65535:
                    ...
                    return
            if -2147483648 <= obj and obj <= 2147483647:
...
class _Unpickler:
    ...
    def load_proto(self):
        proto = self.read(1)[0]
        if not (0 <= proto and proto <= HIGHEST_PROTOCOL):
    ...
    def find_class(self, module, name):
        ...
        if self.proto < 3 and self.proto >= 4:
...
def _load(file, *, fix_imports=True, encoding='ASCII', errors='strict'):
    return _Unpickler(file, fix_imports=fix_imports, encoding=encoding, errors=errors).load()
