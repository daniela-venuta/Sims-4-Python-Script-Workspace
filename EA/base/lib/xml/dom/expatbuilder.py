...
class ExpatBuilder:
    ...
    def start_doctype_decl_handler(self, doctypeName, systemId, publicId, has_internal_subset):
        ...
        if self._filter and has_internal_subset:
...
class FilterVisibilityController(object):
    ...
    _nodetype_mask = {Node.NOTATION_NODE: NodeFilter.SHOW_NOTATION, Node.DOCUMENT_FRAGMENT_NODE: NodeFilter.SHOW_DOCUMENT_FRAGMENT, Node.DOCUMENT_TYPE_NODE: NodeFilter.SHOW_DOCUMENT_TYPE, Node.DOCUMENT_NODE: NodeFilter.SHOW_DOCUMENT, Node.COMMENT_NODE: NodeFilter.SHOW_COMMENT, Node.PROCESSING_INSTRUCTION_NODE: NodeFilter.SHOW_PROCESSING_INSTRUCTION, Node.ENTITY_NODE: NodeFilter.SHOW_ENTITY, Node.ENTITY_REFERENCE_NODE: NodeFilter.SHOW_ENTITY_REFERENCE, Node.CDATA_SECTION_NODE: NodeFilter.SHOW_CDATA_SECTION, Node.TEXT_NODE: NodeFilter.SHOW_TEXT, Node.ATTRIBUTE_NODE: NodeFilter.SHOW_ATTRIBUTE, Node.ELEMENT_NODE: NodeFilter.SHOW_ELEMENT}
