...
class _PlistWriter(_DumbXMLWriter):
    ...
    def write_value(self, value):
        if isinstance(value, str):
            ...
            if -9223372036854775808 <= value and value < 18446744073709551616:
...
_FORMATS = {FMT_BINARY: dict(detect=_is_fmt_binary, parser=_BinaryPlistParser, writer=_BinaryPlistWriter), FMT_XML: dict(detect=_is_fmt_xml, parser=_PlistParser, writer=_PlistWriter)}
