...
class Snapshot:
    ...
    def _filter_trace(self, include_filters, exclude_filters, trace):
        if include_filters and not any(trace_filter._match(trace) for trace_filter in include_filters):
            return False
        elif exclude_filters and any(not trace_filter._match(trace) for trace_filter in exclude_filters):
            return False
        return True
