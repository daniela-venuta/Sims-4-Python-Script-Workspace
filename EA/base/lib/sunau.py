...
class Au_read:
    ...
    def getnframes(self):
        ...
        elif self._encoding in _simple_encodings:
...
def openfp(f, mode=None):
    warnings.warn('sunau.openfp is deprecated since Python 3.7. Use sunau.open instead.', DeprecationWarning, stacklevel=2)
