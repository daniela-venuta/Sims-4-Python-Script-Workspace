...
sims4.tuning.instances.lock_instance_tunables(WalkbyAmbientSituation, exclusivity=situations.bouncer.bouncer_types.BouncerExclusivityCategory.WALKBY, creation_ui_option=situations.situation_types.SituationCreationUIOption.NOT_AVAILABLE, duration=0, duration_randomizer=0, _implies_greeted_status=False)
