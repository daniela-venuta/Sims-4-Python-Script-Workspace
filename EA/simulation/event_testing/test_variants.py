...
class GigSpecificFactory(HasTunableSingletonFactory, AutoFactoryInit):
    ...
    def test(self, career):
        ...
        if current_gig is None:
            return False
        if self.active_objective is not None and not current_gig.is_objective_active(self.active_objective):
            return False
