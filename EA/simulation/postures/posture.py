    ...
    def add_appearance_modifier_entry_event(self, arb):
        if self.appearance_modifier is not None:
            ...
            def _apply_appearance_modifier(*_, **__):
                ...
                self.sim.sim_info.appearance_tracker.add_appearance_modifiers(new_appearance_modifier.appearance_modifiers, self.posture_type.guid64, new_appearance_modifier.priority, new_appearance_modifier.apply_to_all_outfits, new_appearance_modifier.additional_flags, source=self.name)
