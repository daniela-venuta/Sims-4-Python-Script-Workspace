...
class SlotComponent(GetPutComponentMixin, NativeComponent, component_name=types.SLOT_COMPONENT, key=787604481):
    ...
    def __init__(self, *args, autonomy_modifiers=DEFAULT, return_owned_objects=DEFAULT, slot_provided_affordances=DEFAULT, state_values_tuning=DEFAULT, **kwargs):
