...
class CardBattleBehavior(HasTunableFactory, AutoFactoryInit):
    ...
    def _set_prop_override(self, prop_overrides, override_name, card_definition):
        prop_overrides[override_name] = sims4.collections.FrozenAttributeDict({'states_to_override': (), 'special_cases': None, 'from_actor': None, 'definition': card_definition, 'sharing': None, 'set_as_actor': None})
