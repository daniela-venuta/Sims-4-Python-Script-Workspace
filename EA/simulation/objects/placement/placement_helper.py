...
class TunablePlacementStrategyVariant(TunableVariant):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, inventory=_PlacementStrategyInventory.TunableFactory(), location=_PlacementStrategyLocation.TunableFactory(), slot=_PlacementStrategySlot.TunableFactory(), default='location', **kwargs)
