...
@total_ordering
class Definition:
    __slots__ = ('_name', 'id', '_components', '_icon', '_model', '_material_variant', '_thumbnail_geo_state_hash', '_rig', '_footprint', '_tuning_file_id', '_slot', '_slots_resource', '_catalog_price', '_environment_mood_tags', '_environment_scores', '_negative_environment_score', '_positive_environment_score', 'build_buy_tags', '_cls')
