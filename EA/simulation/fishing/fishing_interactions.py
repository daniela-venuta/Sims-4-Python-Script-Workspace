...
class FishingLocationCatchOutcome(interactions.utils.outcome.InteractionOutcomeSingle):
    ...
    def _build_elements(self, interaction):
        ...
        def setup_asm_override(asm):
            ...
            if not result:
                return result
            prop_override = sims4.collections.FrozenAttributeDict({'states_to_override': (), 'special_cases': None, 'from_actor': None, 'definition': self._prop_override, 'sharing': None, 'set_as_actor': None})
