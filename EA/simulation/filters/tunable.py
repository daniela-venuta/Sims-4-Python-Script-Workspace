    ...
    def conform_sim_info_to_filter_term(self, created_sim_info, **kwargs):
        ...
        if career is not None:
            ...
            if self.invert_score:
                ...
                if self.career_level is not None:
                    career_tracker.add_career(career, user_level_override=self.career_level.user_level_override(), career_level_override=self.career_level.career_level_override())
                else:
