...
class CareerBase(CoworkerMixin, CareerKnowledgeMixin, sims.sim_spawner_service.ISimSpawnerServiceCustomer):
    ...
    def is_career_available(cls, inst, sim_info=DEFAULT, from_join=False):
        ...
        if from_join or inst_or_cls.allow_multiple_careers or any(career.guid64 != inst_or_cls.guid64 and (career.career_category != CareerCategory.AdultPartTime and career.career_category == inst_or_cls.career_category) for career in sim_info.career_tracker):
            return False
    ...
    def _get_follow_up_gig_data(self):
        if self._upcoming_gig is None or self._upcoming_gig.follow_up_gig is None:
            return (None, None, None)
