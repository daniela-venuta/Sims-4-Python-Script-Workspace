...
class _TraitConflictTest(HasTunableSingletonFactory, AutoFactoryInit):
    ...
    def __call__(self, trait_tracker_a, trait_tracker_b, invert_result, tooltip):
        ...
        if test_pass:
            ...
            return TestResult(False, '{} and {} trait conflict test failed. Conflicts: {}, Invert test: {}', trait_tracker_a._sim_info, trait_tracker_b._sim_info, conflicts, invert_result, tooltip=tooltip)
...
class _TraitMatchTest(HasTunableSingletonFactory, AutoFactoryInit):
    ...
    def __call__(self, trait_tracker_a, trait_tracker_b, invert_result, tooltip):
        ...
        if test_pass:
            ...
            return TestResult(False, '{} and {} trait match test failed. Trait type: {}, Matches: {}, Min matches: {}, Invert result: {}', trait_tracker_a._sim_info, trait_tracker_b._sim_info, self.trait_type, matches, min_matches, invert_result, tooltip=tooltip)
...
class GenderPreferenceTest(HasTunableSingletonFactory, AutoFactoryInit, BaseTest):
    ...
    def _check_gender_preference(self, sim_a, sim_b, overide_target_gender=None):
        ...
        if self.fallback_if_no_perference_is_set and not sim_a.has_gender_preference_been_set():
