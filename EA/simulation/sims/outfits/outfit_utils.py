...
class OutfitGeneratorRandomizationMixin:
    ...
    def _generate_outfit(self, sim_info, outfit_category, outfit_index=0, tag_list=(), seed=None):
        ...
        sim_info.generate_outfit(outfit_category, outfit_index=outfit_index, tag_list=tag_list, filter_flag=self.filter_flag, body_type_chance_overrides=self.body_type_chance_overrides, body_type_match_not_found_overrides=self.body_type_match_not_found_policy, seed=seed, body_type_flags=body_type_flags)
