            ...
            if desired_level is not None:
                ...
                if self.destination_jig is not None:
                    ...
                    if self._destination_jig_object is not None:
                        (position, orientation) = TeleportHelper.get_fgl_at_destination_for_teleport(starting_location, self._destination_jig_object, destination_must_be_outside=self.destination_must_be_outside, min_head_room=sim_head_room)
                    ...
                    (final_position, _) = TeleportHelper.get_fgl_at_destination_for_teleport(starting_location, self.sim, ignore_connectivity=True, destination_must_be_outside=self.destination_must_be_outside, min_head_room=sim_head_room)
                    if final_position is not None:
                        (position, orientation) = TeleportHelper.get_fgl_at_destination_for_teleport(starting_location, self.sim, destination_must_be_outside=self.destination_must_be_outside, min_head_room=sim_head_room)
                        if services.current_zone().lot.is_position_on_lot(starting_position):
                            ...
                            if front_door:
                                ...
                                (position, orientation) = TeleportHelper.get_fgl_at_destination_for_teleport(door_location, self.sim, destination_must_be_outside=self.destination_must_be_outside, ignore_connectivity=True, min_head_room=sim_head_room)
                        if orientation is not None:
