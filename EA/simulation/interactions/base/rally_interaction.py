...
class RallyInteraction(ProxyInteraction):
    ...
    def _do_rally_behavior(self, sim, constraint):
        if self.rally_data is not None:
            ...
            if hasattr(self.rally_data, 'preserve_preferred_objects') and affordance is None or static_commodity is not None:
                if static_commodity is not None:
                    ...
                    if target is not None:
                        ...
                        return sim.push_super_affordance(affordance, target, context, from_rally_interaction=self, push_social=self.rally_push_social, **interaction_parameters)
                else:
                    return False
            else:
